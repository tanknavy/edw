package com.tanknavy.logs;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.tanknavy.logs.bean.*;
...
/**
 * Created by Alex Cheng 6/3/2020 1:09 PM
 * generate log to json format
 * 日志行为数据模拟
 * 每条延时，默认0s,循环遍历次数，默认1000
 */
public class LogCollectApp {

    private final static Logger logger = LoggerFactory.getLogger(LogCollectApp.class);
    ...
    public static void main(String[] args) {//判断输入参数
